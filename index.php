...
elseif (isset($_GET["userID"]) && !isset($_COOKIE["loggedInBG"])) {
    $getGames = "Select distinct b.* from brettspiele as b left join game2tag as g2g on b.ID =g2g.IDGAME join user2game as u2g on b.ID=u2g.IDGAME where u2g.IDUSER='" . $_GET["userID"] . "' and u2g.STATUS=0 and ERWEITERUNG is Null";
}
else {
